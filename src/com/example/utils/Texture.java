...
//    public Bitmap mBitmap;
    public ILoadTexImage mILoadTexImage;
	TextureReference mTextureRef;
	
	public void bindTextureReference(TextureReference textureRef) {
...
//        	mBitmap = null;
//        }
        if (mILoadTexImage != null) {
        	mILoadTexImage.recycle();
        	mILoadTexImage = null;
		}
    }
...
//    protected abstract Bitmap load(RenderView view);
    public abstract ILoadTexImage load();
