...
//        Log.i(TAG , "pollFirst(), head = " + head + ", mHead = " + mHead + ", array.length = " + array.length);
        return result;
    }
...
//        Log.i(TAG , "expand(), head = " + head + ", array.length = " + array.length + ", rightSize = " + rightSize + ", newArray.length = " + newArray.length);
        mArray = (E[]) newArray;
        mHead = 0;
        mTail = capacity;
    }
