...
public class Matrix4f {
    ...
    final void invertGeneral(Matrix4f m1) {
		...
		Matrix.invertM(invM, 0, temp, 0);//求逆矩阵
		
        this.m00 = (float) invM[0];
        this.m01 = (float) invM[1];
        this.m02 = (float) invM[2];
        this.m03 = (float) invM[3];

        this.m10 = (float) invM[4];
        this.m11 = (float) invM[5];
        this.m12 = (float) invM[6];
        this.m13 = (float) invM[7];

        this.m20 = (float) invM[8];
        this.m21 = (float) invM[9];
        this.m22 = (float) invM[10];
        this.m23 = (float) invM[11];

        this.m30 = (float) invM[12];
        this.m31 = (float) invM[13];
        this.m32 = (float) invM[14];
        this.m33 = (float) invM[15];
    }
//    /**
